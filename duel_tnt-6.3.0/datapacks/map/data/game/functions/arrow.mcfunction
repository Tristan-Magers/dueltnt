#wizard fireball bow
execute unless entity @e[scores={mode=1}] run execute as @s[type=arrow,scores={isBall=1}] at @s run summon minecraft:fireball ~ ~1.2 ~ {Motion:[0.0d, 0.0d, 0.0d],Invulnerable:0b,Air:300s,OnGround:0b,Dimension:0,ExplosionPower:4,PortalCooldown:0,Rotation:[0.0f,0.0f],Fire:-1s,power:[0.0d,0.001d,-0.0d],direction:[0.0d, 0.0d, 0.0d]}
...
execute as @s[type=arrow,x=599,z=599,y=5,dx=36,dz=36,dy=25,distance=..1000,scores={Inbarrier=..0,isBall=3}] at @s run clone ~-1 ~-2 ~-1 ~1 ~1 ~1 ~-1 ~2 ~-1 masked
...
execute as @s[type=arrow,x=599,z=599,y=5,dx=36,dz=36,dy=25,distance=..1000,scores={Inbarrier=..0,isBall=3}] positioned ~-2 ~-2 ~-2 run execute as @e[distance=..10,dx=2,dz=2,dy=3.5,type=!armor_stand] at @s run tp @s ~ ~4 ~
