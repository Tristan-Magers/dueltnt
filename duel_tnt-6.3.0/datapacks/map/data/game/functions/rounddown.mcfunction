...
execute as @s[scores={Rounds=..1}] at @s run data merge block 475 17 495 {Text1:"[{\"text\":\"\"}]",Text2:"[{\"score\":{\"name\":\"Round\",\"objective\":\"game\"},\"bold\":\"true\"}]",Text3:"[{\"text\":\"Round(s)\"}]",Text4:"[{\"text\":\"\"}]"}
