...
execute as @e[type=item,scores={egg=60..},nbt={Item:{id:"minecraft:nether_star"}}] at @s run summon tnt ~ ~ ~ {Fuse:2}
execute as @e[type=item,scores={egg=60..},nbt={Item:{id:"minecraft:nether_star"}}] at @s run summon tnt ~ ~ ~ {Fuse:2}
kill @e[type=item,scores={egg=60..},nbt={Item:{id:"minecraft:nether_star"}}]
...
execute as @a at @s run execute as @e[limit=1,type=item,scores={Mine=2..,egg=12},distance=..20] at @s run summon magma_cube ~ ~ ~ {NoGravity:1,NoAI:0,Invulnerable:1,Size:2,CustomName:"{\"text\":\"star\"}",Silent:1,Attributes:[{Name:generic.followRange,Base:0},{Name:generic.movementSpeed,Base:0}]}
...
execute as @e[type=item,scores={Mine=2..,egg=12..}] at @s positioned ~ ~-.4 ~ run function game:getcube
