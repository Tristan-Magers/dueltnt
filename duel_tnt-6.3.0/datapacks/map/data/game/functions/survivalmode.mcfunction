...
execute run execute as @a[x=600,y=60,z=600,distance=3..100,gamemode=adventure,limit=1] at @s run function game:survival
...
execute run execute as @e[type=chicken] at @s run function game:survivalchicken
