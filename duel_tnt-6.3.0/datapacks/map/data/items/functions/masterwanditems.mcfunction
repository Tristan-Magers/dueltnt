...
replaceitem entity @s[scores={masterb=15..}] hotbar.4 minecraft:beef{display:{Name:"{\"italic\":false,\"text\":\"§cBoom Halo §r: Right-click (15 Material)\"}",Lore:["{\"italic\":false,\"text\":\"§4Beef\"}"]}}
...
clear @s[scores={masterb=..14}] beef
replaceitem entity @s[scores={masterb=..14}] hotbar.4 minecraft:barrier{display:{Name:"{\"italic\":false,\"text\":\"§9Not enough material\"}"}} 1

replaceitem entity @s[scores={masterb=7..}] hotbar.1 minecraft:salmon{display:{Name:"{\"italic\":false,\"text\":\"§4Matter Bomb §r: Right-click (7 Material)\"}"}}
clear @s[scores={masterb=..6}] salmon
replaceitem entity @s[scores={masterb=..6}] hotbar.1 minecraft:barrier{display:{Name:"{\"italic\":false,\"text\":\"§9Not enough material\"}"}} 1

replaceitem entity @s[scores={masterb=15..}] hotbar.2 minecraft:cooked_cod{display:{Name:"{\"italic\":false,\"text\":\"§2Land Slide §r: Right-click (15 Material)\"}"}}
clear @s[scores={masterb=..14}] cooked_cod
replaceitem entity @s[scores={masterb=..14}] hotbar.2 minecraft:barrier{display:{Name:"{\"italic\":false,\"text\":\"§9Not enough material\"}"}} 1
