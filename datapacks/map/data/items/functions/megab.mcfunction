...
execute as @s[scores={BBtimer=159}] at @s run function items:megabsummon
...
item replace entity @s[scores={BBtimer=1},x=620,y=20,z=620,distance=3..100] hotbar.3 with kelp{display:{Name:"{\"italic\":false,\"text\":\"§4Mega Bomb§r : Right Click\"}",color:16777215}}