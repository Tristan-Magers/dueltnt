...
execute unless entity @e[scores={mode=1}] run replaceitem entity @s[scores={masterb=26..,masterup=..3}] hotbar.3 minecraft:cod{display:{Name:"{\"italic\":false,\"text\":\"§9Upgrade Wand §r: Right-click (26 Material)\"}"}}
...
execute unless entity @e[scores={mode=1}] run replaceitem entity @s[scores={masterb=..25,masterup=..3}] hotbar.3 minecraft:barrier{display:{Name:"{\"italic\":false,\"text\":\"§9Not enough material\"}"}} 1
...
replaceitem entity @s[scores={masterb=17..}] hotbar.2 minecraft:cooked_cod{display:{Name:"{\"italic\":false,\"text\":\"§2Land Slide §r: Right-click (17 Material)\"}"}}
clear @s[scores={masterb=..16}] cooked_cod
replaceitem entity @s[scores={masterb=..16}] hotbar.2 minecraft:barrier{display:{Name:"{\"italic\":false,\"text\":\"§9Not enough material\"}"}} 1
