...
replaceitem entity @s[x=600,y=60,z=600,distance=3..95,scores={class=2,potion=-1}] hotbar.4 minecraft:splash_potion{CustomPotionColor:0,CustomPotionEffects:[{Id:15,Amplifier:1,Duration:72},{Id:24,Amplifier:1,Duration:72}],display:{Name:"{\"italic\":false,\"text\":\"§5Primed for Dark §r: Right-click\"}"}}
