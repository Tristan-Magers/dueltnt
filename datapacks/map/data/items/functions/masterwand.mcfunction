...
execute as @s[tag=!end,scores={masterup=1..}] at @s anchored eyes positioned ^ ^ ^9.0 run function items:masterwandtest
execute as @s[tag=!end,scores={masterup=1..}] at @s anchored eyes positioned ^ ^ ^9.4 run function items:masterwandtest
execute as @s[tag=!end,scores={masterup=1..}] at @s anchored eyes positioned ^ ^ ^9.8 run function items:masterwandtest
