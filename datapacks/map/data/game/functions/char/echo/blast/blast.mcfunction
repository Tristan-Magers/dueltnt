...
execute unless entity @e[scores={mode=1}] run execute as @s[scores={blast=74..}] at @s run particle crit ~ ~ ~ .2 .2 .2 0 20 force
execute if entity @e[scores={mode=1}] run execute as @s[scores={blast=94..}] at @s run particle crit ~ ~ ~ .2 .2 .2 0 20 force

execute unless entity @e[scores={mode=1}] run kill @s[scores={blast=74..}]
