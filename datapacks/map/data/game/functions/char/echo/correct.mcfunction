...
clear @s[nbt=!{Inventory:[{id:"minecraft:pink_dye",Slot:2b,tag:{BlastOrb:1b}}]},scores={blastwandtime=89..90}] pink_dye{BlastOrb:1b}
item replace entity @s[nbt=!{Inventory:[{id:"minecraft:pink_dye",Slot:2b,tag:{BlastOrb:1b}}]},scores={blastwandtime=89..90}] hotbar.2 with minecraft:pink_dye{display:{Name:"{\"italic\":false,\"text\":\"§eUnstable Orb §r: Right-click\"}"},AttributeModifiers:[{AttributeName:"generic.attack_speed",Name:"generic.attackSpeed",Amount:10,Operation:0,UUIDLeast:77216,UUIDMost:618122}],BlastOrb:1b}
...
clear @s[nbt=!{Inventory:[{id:"minecraft:pink_dye",Slot:1b,tag:{BoomOrb:1b}}]},tag=boomshard,scores={boomwandtime=12..54}] pink_dye
item replace entity @s[nbt=!{Inventory:[{id:"minecraft:pink_dye",Slot:1b,tag:{BoomOrb:1b}}]},tag=boomshard,scores={boomwandtime=12..54}] hotbar.1 with minecraft:pink_dye{display:{Name:"{\"italic\":false,\"text\":\"§eUnstable Orb §r: Right-click\"}"},AttributeModifiers:[{AttributeName:"generic.attack_speed",Name:"generic.attackSpeed",Amount:10,Operation:0,UUIDLeast:77216,UUIDMost:618122}],BoomOrb:1b}
