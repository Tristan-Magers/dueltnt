...
execute as @s[tag=!end,scores={masterup=2..}] at @s anchored eyes positioned ^ ^ ^8.6 run function game:char/overlord/masterwandtest
...
execute as @s[tag=!end,scores={masterup=3..}] at @s anchored eyes positioned ^ ^ ^9.8 run function game:char/overlord/masterwandtest
execute as @s[tag=!end,scores={masterup=3..}] at @s anchored eyes positioned ^ ^ ^10.2 run function game:char/overlord/masterwandtest
execute as @s[tag=!end,scores={masterup=3..}] at @s anchored eyes positioned ^ ^ ^10.6 run function game:char/overlord/masterwandtest

execute as @s[tag=!end,scores={masterup=4..}] at @s anchored eyes positioned ^ ^ ^11.0 run function game:char/overlord/masterwandtest
execute as @s[tag=!end,scores={masterup=4..}] at @s anchored eyes positioned ^ ^ ^11.4 run function game:char/overlord/masterwandtest
