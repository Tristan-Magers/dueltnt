...
execute as @s[tag=!end,scores={masterup=1..}] at @s anchored eyes positioned ^ ^ ^6.2 run function game:char/overlord/masterwandtest
execute as @s[tag=!end,scores={masterup=1..}] at @s anchored eyes positioned ^ ^ ^6.6 run function game:char/overlord/masterwandtest
execute as @s[tag=!end,scores={masterup=1..}] at @s anchored eyes positioned ^ ^ ^7.0 run function game:char/overlord/masterwandtest
execute as @s[tag=!end,scores={masterup=1..}] at @s anchored eyes positioned ^ ^ ^7.4 run function game:char/overlord/masterwandtest
execute as @s[tag=!end,scores={masterup=1..}] at @s anchored eyes positioned ^ ^ ^7.8 run function game:char/overlord/masterwandtest
...
execute as @s[tag=!end,scores={masterup=2..}] at @s anchored eyes positioned ^ ^ ^9.0 run function game:char/overlord/masterwandtest
...
execute as @s[tag=!end,scores={masterup=2..}] at @s anchored eyes positioned ^ ^ ^10.6 run function game:char/overlord/masterwandtest
execute as @s[tag=!end,scores={masterup=2..}] at @s anchored eyes positioned ^ ^ ^11.0 run function game:char/overlord/masterwandtest
execute as @s[tag=!end,scores={masterup=2..}] at @s anchored eyes positioned ^ ^ ^11.4 run function game:char/overlord/masterwandtest

execute as @s[tag=!end,scores={masterup=3..}] at @s anchored eyes positioned ^ ^ ^11.8 run function game:char/overlord/masterwandtest
execute as @s[tag=!end,scores={masterup=3..}] at @s anchored eyes positioned ^ ^ ^12.2 run function game:char/overlord/masterwandtest
execute as @s[tag=!end,scores={masterup=3..}] at @s anchored eyes positioned ^ ^ ^12.6 run function game:char/overlord/masterwandtest
execute as @s[tag=!end,scores={masterup=3..}] at @s anchored eyes positioned ^ ^ ^13.0 run function game:char/overlord/masterwandtest
execute as @s[tag=!end,scores={masterup=3..}] at @s anchored eyes positioned ^ ^ ^13.4 run function game:char/overlord/masterwandtest
execute as @s[tag=!end,scores={masterup=3..}] at @s anchored eyes positioned ^ ^ ^13.8 run function game:char/overlord/masterwandtest
execute as @s[tag=!end,scores={masterup=3..}] at @s anchored eyes positioned ^ ^ ^14.2 run function game:char/overlord/masterwandtest

execute as @s[tag=!end,scores={masterup=4..}] at @s anchored eyes positioned ^ ^ ^14.6 run function game:char/overlord/masterwandtest
execute as @s[tag=!end,scores={masterup=4..}] at @s anchored eyes positioned ^ ^ ^15.0 run function game:char/overlord/masterwandtest
execute as @s[tag=!end,scores={masterup=4..}] at @s anchored eyes positioned ^ ^ ^15.4 run function game:char/overlord/masterwandtest
