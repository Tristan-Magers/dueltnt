...
execute as @s[nbt=!{Inventory:[{id:"minecraft:ender_pearl",Slot:2b}]},scores={enderreload=0}] at @s run tellraw @a [{"selector":"@s","color":"gold"},{"text":" Reloaded ","color":"white"},{"text":"Teleport","color":"green","bold":"true"}]
...
#item replace entity @s[nbt=!{Inventory:[{id:"minecraft:ender_pearl",Slot:2b}]},scores={endercount=0}] hotbar.2 with minecraft:ender_pearl{display:{Name:"{\"italic\":false,\"text\":\"§aTeleport §r: Right-click\"}"}} 2
