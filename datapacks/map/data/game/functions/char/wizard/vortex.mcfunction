execute as @s at @s anchored eyes positioned ^ ^ ^3.7 run summon minecraft:armor_stand ~ ~1 ~ {Small:1,NoGravity:1,Marker:1,Silent:1,Invulnerable:1,Invisible:1,CustomName:"{\"italic\":false,\"text\":\"vortex\"}"}
execute as @s at @s anchored eyes positioned ^ ^ ^3.7 run summon minecraft:armor_stand ~ ~ ~ {Small:1,NoGravity:1,Marker:1,Silent:1,Invulnerable:1,Invisible:1,ArmorItems:[{},{},{},{id:"minecraft:white_stained_glass",Count:1b}],Tags:["vortex_box"]}
