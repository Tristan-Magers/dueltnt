...
item replace entity @s[x=620,y=20,z=620,distance=..100,scores={class=4,pig=-119},tag=pig_place] hotbar.3 with pig_spawn_egg[custom_name='{"italic":false,"text":"§cPig Transform §r: Throw or Place"}',can_place_on={predicates:[{blocks:["#game:bolt_place"]}],show_in_tooltip:0b},entity_data={id:"pig"}]
...
item replace entity @s[x=620,y=20,z=620,distance=..100,scores={class=4,pig=-129}] hotbar.3 with pig_spawn_egg[custom_name='{"italic":false,"text":"§cPig Transform §r: Throw or Place"}',can_place_on={predicates:[{blocks:["#game:bolt_place"]}],show_in_tooltip:0b},entity_data={id:"pig"}]
