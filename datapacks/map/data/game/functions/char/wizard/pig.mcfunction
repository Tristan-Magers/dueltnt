...
item replace entity @s[x=620,y=20,z=620,distance=..100,scores={class=4,pig=-129}] hotbar.3 with pig_spawn_egg{display:{Name:"{\"italic\":false,\"text\":\"§cPig Transform §r: Throw or Place\"}"},CanPlaceOn:["#game:bolt_place"],EntityTag:{id:pig},HideFlags:16}
