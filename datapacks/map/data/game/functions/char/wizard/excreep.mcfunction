...
item replace entity @s[x=600,y=60,z=600,distance=3..95,scores={CPtimer=1},tag=hascreep] hotbar.4 with golden_boots[custom_name='{"text":"§r§bExplode Ghost Creepers §f: Right Click"}']
