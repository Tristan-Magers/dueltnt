...
execute as @s[scores={t1=1,t2=0}] at @s if entity @e[tag=dummy,distance=..16] unless entity @a[scores={tntID=0},distance=..3.0] run tag @s add down
execute as @s[scores={t1=1,t2=0}] at @s if entity @a[scores={tntID=1..},distance=..16] unless entity @a[scores={tntID=0},distance=..3.0] run tag @s add down
execute as @s[scores={t1=1,t2=0}] at @s if entity @a[scores={tntID=..-1},distance=..16] unless entity @a[scores={tntID=0},distance=..3.0] run tag @s add down
