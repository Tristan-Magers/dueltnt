...
execute as @s at @s run summon creeper ~ ~ ~ {Invulnerable:1,ignited:1,powered:1,Fuse:7,Attributes:[{Name:generic.follow_range,Base:0},{Name:generic.movement_speed,Base:0}],Tags:["newmotme"],Motion:[0.0,2.0,0.0]}
execute as @s at @s run summon creeper ~ ~ ~ {Invulnerable:1,ignited:1,powered:1,Fuse:7,Attributes:[{Name:generic.follow_range,Base:0},{Name:generic.movement_speed,Base:0}],Tags:["newmotme"],Motion:[0.0,2.0,0.0]}
