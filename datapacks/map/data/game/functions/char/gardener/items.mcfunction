...
execute as @s[scores={gardlife=800,Lives=..6}] at @s run tellraw @a [{"selector":"@s"},{"text":" gained an ","color":"gray","bold":false},{"text":"Extra Life","color":"green","bold":true},{"text":" as gardener","color":"gray","bold":false}]
