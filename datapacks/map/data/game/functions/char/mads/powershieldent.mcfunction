...
execute as @s[scores={PS=..6},x=600,y=60,z=600,distance=3..100] at @s run fill ~-2 ~-2 ~-2 ~2 ~2 ~2 white_stained_glass replace air
execute as @s[scores={PS=55..},x=600,y=60,z=600,distance=3..100] at @s run fill ~-2 ~-2 ~-2 ~2 ~2 ~2 air replace white_stained_glass
execute as @s[scores={PS=55..},x=600,y=60,z=600,distance=3..100] at @s run fill ~-2 ~-2 ~-2 ~2 ~2 ~2 air replace blue_ice
kill @s[scores={PS=55..}]
