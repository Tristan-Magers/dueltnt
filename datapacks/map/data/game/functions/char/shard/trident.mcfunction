...
#execute as @s[tag=boom] at @s run tp @s @s

scoreboard players add @s[tag=boom] t4 1

execute as @s[scores={t4=4}] at @s run summon slime ~ ~-2.7 ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Size:9,Tags:["kill_next"],active_effects:[{Id:14,Amplifier:1b,Duration:10,ShowParticles:0b}]}
execute as @s[scores={t4=4}] at @s run summon slime ~ ~-2.7 ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Size:9,Tags:["kill_next"],active_effects:[{Id:14,Amplifier:1b,Duration:10,ShowParticles:0b}]}
...
execute as @s[scores={t4=4}] at @s run summon block_display ~-2.2 ~-3.2 ~-2.2 {NoGravity:1b,Silent:1b,Tags:["kill_next"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[4.4f,4.4f,4.4f]},block_state:{Name:"minecraft:white_stained_glass"}}
execute as @s[scores={t4=4}] at @s run summon block_display ~-2.7 ~-3.2 ~-2.7 {NoGravity:1b,Silent:1b,Tags:["kill_next"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[5.4f,5.4f,5.4f]},block_state:{Name:"minecraft:white_stained_glass"}}
execute as @s[scores={t4=4}] at @s run summon block_display ~-3.2 ~-3.2 ~-3.2 {NoGravity:1b,Silent:1b,Tags:["kill_next"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[6.4f,6.4f,6.4f]},block_state:{Name:"minecraft:white_stained_glass"}}
