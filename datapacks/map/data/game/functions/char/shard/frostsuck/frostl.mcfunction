...
#execute as @s[scores={frostl=0..}] at @s run setblock ~ ~ ~ blue_ice

execute as @s[scores={frostl=..-1}] run scoreboard players operation @e[tag=frostplat] objID -= @s objID
execute at @s[scores={frostl=..-1}] if block ~ ~ ~ minecraft:blue_ice run tag @e[tag=frostplat,scores={objID=0}] add grow
execute at @s[scores={frostl=..-1}] if block ~ ~ ~ minecraft:blue_ice run scoreboard players add @e[tag=frostplat,scores={objID=0}] frostsize 1
execute as @s[scores={frostl=..-1}] run scoreboard players operation @e[tag=frostplat] objID += @s objID
