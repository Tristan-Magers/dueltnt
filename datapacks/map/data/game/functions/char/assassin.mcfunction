...
replaceitem entity @s[scores={dartcool=0,dartuse=0}] hotbar.4 minecraft:leather 6
replaceitem entity @s[scores={dartcool=0,dartuse=1}] hotbar.4 minecraft:leather 5
replaceitem entity @s[scores={dartcool=0,dartuse=2}] hotbar.4 minecraft:leather 4
replaceitem entity @s[scores={dartcool=0,dartuse=3}] hotbar.4 minecraft:leather 3
replaceitem entity @s[scores={dartcool=0,dartuse=4}] hotbar.4 minecraft:leather 2
replaceitem entity @s[scores={dartcool=0,dartuse=5}] hotbar.4 minecraft:leather 1
#replaceitem entity @s[scores={dartcool=0,dartuse=6}] hotbar.4 minecraft:leather 1
...
replaceitem entity @s[scores={starT=105..}] hotbar.1 nether_star{display:{Name:"{\"italic\":false,\"text\":\"Magic Star §r: Right-click\"}"}} 2
...
replaceitem entity @s[scores={FZtimer=159..}] armor.feet air
scoreboard players set @s[scores={FZtimer=50}] FZtimer 20
...
replaceitem entity @s[scores={FZtimer=1}] hotbar.3 diamond{display:{Name:"{\"italic\":false,\"text\":\"§3Mass Freeze§r §r: Right-click [everyone within 3 blocks]\"}"}}
