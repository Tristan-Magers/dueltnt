...
execute as @s at @s positioned ~ ~-2.1 ~ run execute as @a[distance=..1.65,gamemode=adventure,scores={class=8}] at @s run function game:plaguegar
execute as @s at @s positioned ~ ~-1.1 ~ run execute as @a[distance=..1.65,gamemode=adventure,scores={class=8}] at @s run function game:plaguegar
execute as @s at @s positioned ~ ~ ~ run execute as @a[distance=..1.65,gamemode=adventure,scores={class=8}] at @s run function game:plaguegar
