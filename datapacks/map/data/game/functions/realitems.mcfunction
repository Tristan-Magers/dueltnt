...
execute as @e[type=item,scores={egg=50..},nbt={Item:{id:"minecraft:nether_star"}}] at @s run summon tnt ~ ~ ~ {Fuse:2}
execute as @e[type=item,scores={egg=50..},nbt={Item:{id:"minecraft:nether_star"}}] at @s run summon tnt ~ ~ ~ {Fuse:2}
kill @e[type=item,scores={egg=50..},nbt={Item:{id:"minecraft:nether_star"}}]
