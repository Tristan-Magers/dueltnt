...
execute as @a[scores={storm_cooldown=0}] run function game:char/overlord/masterwanditems
...
execute as @a[scores={master_bomb_cooldown=0}] run function game:char/overlord/masterwanditems
