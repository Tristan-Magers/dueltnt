...
execute as @p[gamemode=adventure,distance=..10,scores={class=10}] at @s run function game:uuidsetf2
...
execute as @p[gamemode=adventure,distance=..10,scores={class=10}] at @s run function game:uuidsetf
scoreboard players set @e[tag=farrowt] FrostBow 1
