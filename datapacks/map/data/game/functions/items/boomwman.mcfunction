...
item replace entity @s[scores={boomwandtime=55},tag=boomshard] hotbar.1 with minecraft:pink_dye{display:{Name:"{\"italic\":false,\"text\":\"§eUnstable Orb §r: Right-click\"}"},AttributeModifiers:[{AttributeName:"generic.attackSpeed",Name:"generic.attackSpeed",Amount:10,Operation:0,UUIDLeast:77216,UUIDMost:618122}]}