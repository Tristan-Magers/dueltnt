...
item replace entity @s hotbar.3 with minecraft:golden_hoe[custom_name='{"italic":false,"text":"§bRecharging.."}',attribute_modifiers=[{type:"generic.attack_speed",name:"generic.attack_speed",amount:10,operation:"add_value",uuid:[I;1,2,3,4]}]]
