...
item replace entity @s[scores={BBtimer=1},x=620,y=20,z=620,distance=3..100] hotbar.3 with kelp[custom_name='{"italic":false,"text":"§4Mega Bomb§r : Right Click"}',dyed_color=16777215]