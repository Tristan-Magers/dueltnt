...
item replace entity @s[scores={blastdur=1}] hotbar.2 with minecraft:golden_hoe[damage=5,custom_name='{"italic":false,"text":"§aRecharging.."}',attribute_modifiers=[{type:"generic.attack_speed",name:"generic.attack_speed",amount:10,operation:"add_value",uuid:[I;1,2,3,4]}]]
item replace entity @s[scores={blastdur=2}] hotbar.2 with minecraft:golden_hoe[damage=10,custom_name='{"italic":false,"text":"§aRecharging.."}',attribute_modifiers=[{type:"generic.attack_speed",name:"generic.attack_speed",amount:10,operation:"add_value",uuid:[I;1,2,3,4]}]]
item replace entity @s[scores={blastdur=3}] hotbar.2 with minecraft:golden_hoe[damage=15,custom_name='{"italic":false,"text":"§aRecharging.."}',attribute_modifiers=[{type:"generic.attack_speed",name:"generic.attack_speed",amount:10,operation:"add_value",uuid:[I;1,2,3,4]}]]
item replace entity @s[scores={blastdur=4}] hotbar.2 with minecraft:golden_hoe[damage=20,custom_name='{"italic":false,"text":"§aRecharging.."}',attribute_modifiers=[{type:"generic.attack_speed",name:"generic.attack_speed",amount:10,operation:"add_value",uuid:[I;1,2,3,4]}]]
item replace entity @s[scores={blastdur=5}] hotbar.2 with minecraft:golden_hoe[damage=25,custom_name='{"italic":false,"text":"§aRecharging.."}',attribute_modifiers=[{type:"generic.attack_speed",name:"generic.attack_speed",amount:10,operation:"add_value",uuid:[I;1,2,3,4]}]]
item replace entity @s[scores={blastdur=6..}] hotbar.2 with minecraft:golden_hoe[damage=31,custom_name='{"italic":false,"text":"§aRecharging.."}',attribute_modifiers=[{type:"generic.attack_speed",name:"generic.attack_speed",amount:10,operation:"add_value",uuid:[I;1,2,3,4]}]]
