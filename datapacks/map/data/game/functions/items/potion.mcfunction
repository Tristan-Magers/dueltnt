...
item replace entity @s[x=600,y=60,z=600,distance=3..95,scores={class=2,potion=-1}] hotbar.4 with splash_potion[custom_name='[{"text":"Primed for Dark ","color":"dark_purple","italic":false},{"text":": Right-Click","color":"white","italic":false}]',potion_contents={custom_color:0,custom_effects:[{id:"minecraft:blindness",amplifier:1b,duration:80},{id:"minecraft:glowing",amplifier:1b,duration:60}]}]
