...
execute positioned ~-.25 ~.95 ~-.25 as @e[tag=!spectest,tag=!nohit,tag=!wbeam,dx=0] positioned ~-.7 ~-.7 ~-.7 if entity @s[dx=0] run tag @s add beamhit
execute positioned ~.25 ~1.55 ~.25 as @e[tag=!spectest,tag=!nohit,tag=!wbeam,dx=0] positioned ~-.7 ~-.7 ~-.7 if entity @s[dx=0] run tag @s add beamhit
