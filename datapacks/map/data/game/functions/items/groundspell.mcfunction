...
execute as @s[x=580,dx=80,y=2,dy=42,z=580,dz=80,distance=..100] at @s run summon armor_stand ~ ~ ~ {NoGravity:1,Marker:1,Silent:1,Invulnerable:1,Invisible:1,CustomName:"{\"italic\":false,\"text\":\"ground\"}"}
