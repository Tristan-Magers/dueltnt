...
execute as @s at @s positioned ^ ^1 ^ run function game:xmove
scoreboard players operation @s tDirZ = @s DirZ
execute as @s at @s positioned ^ ^1 ^ run function game:zmove
scoreboard players operation @s tDirY = @s DirY
execute as @s at @s positioned ^ ^1 ^ run function game:ymove
