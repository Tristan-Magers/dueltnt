...
execute as @s[scores={countdown=72}] at @s run execute as @a[x=600,y=60,z=600,distance=..3,tag=randclass,gamemode=adventure,scores={class=0}] at @s run tellraw @a [{"selector":"@s","color":"gold"},{"text":" spawning as: ","color":"white"},{"text":"Soldier","color":"red"},{"text":" (random)","color":"white"}]
execute as @s[scores={countdown=72}] at @s run execute as @a[x=600,y=60,z=600,distance=..3,tag=randclass,gamemode=adventure,scores={class=1}] at @s run tellraw @a [{"selector":"@s","color":"gold"},{"text":" spawning as: ","color":"white"},{"text":"Assassin","color":"dark_purple"},{"text":" (random)","color":"white"}]
execute as @s[scores={countdown=72}] at @s run execute as @a[x=600,y=60,z=600,distance=..3,tag=randclass,gamemode=adventure,scores={class=2}] at @s run tellraw @a [{"selector":"@s","color":"gold"},{"text":" spawning as: ","color":"white"},{"text":"Ghost","color":"aqua"},{"text":" (random)","color":"white"}]
execute as @s[scores={countdown=72}] at @s run execute as @a[x=600,y=60,z=600,distance=..3,tag=randclass,gamemode=adventure,scores={class=3}] at @s run tellraw @a [{"selector":"@s","color":"gold"},{"text":" spawning as: ","color":"white"},{"text":"Trapper","color":"red"},{"text":" (random)","color":"white"}]
execute as @s[scores={countdown=72}] at @s run execute as @a[x=600,y=60,z=600,distance=..3,tag=randclass,gamemode=adventure,scores={class=4}] at @s run tellraw @a [{"selector":"@s","color":"gold"},{"text":" spawning as: ","color":"white"},{"text":"Wizard","color":"blue"},{"text":" (random)","color":"white"}]
execute as @s[scores={countdown=72}] at @s run execute as @a[x=600,y=60,z=600,distance=..3,tag=randclass,gamemode=adventure,scores={class=5}] at @s run tellraw @a [{"selector":"@s","color":"gold"},{"text":" spawning as: ","color":"white"},{"text":"Mad Scientist","color":"dark_purple"},{"text":" (random)","color":"white"}]
execute as @s[scores={countdown=72}] at @s run execute as @a[x=600,y=60,z=600,distance=..3,tag=randclass,gamemode=adventure,scores={class=6}] at @s run tellraw @a [{"selector":"@s","color":"gold"},{"text":" spawning as: ","color":"white"},{"text":"Reaper","color":"gray"},{"text":" (random)","color":"white"}]
execute as @s[scores={countdown=72}] at @s run execute as @a[x=600,y=60,z=600,distance=..3,tag=randclass,gamemode=adventure,scores={class=7}] at @s run tellraw @a [{"selector":"@s","color":"gold"},{"text":" spawning as: ","color":"white"},{"text":"Echo","color":"gray"},{"text":" (random)","color":"white"}]
execute as @s[scores={countdown=72}] at @s run execute as @a[x=600,y=60,z=600,distance=..3,tag=randclass,gamemode=adventure,scores={class=8}] at @s run tellraw @a [{"selector":"@s","color":"gold"},{"text":" spawning as: ","color":"white"},{"text":"Gardener","color":"green"},{"text":" (random)","color":"white"}]
execute as @s[scores={countdown=72}] at @s run execute as @a[x=600,y=60,z=600,distance=..3,tag=randclass,gamemode=adventure,scores={class=9}] at @s run tellraw @a [{"selector":"@s","color":"gold"},{"text":" spawning as: ","color":"white"},{"text":"Overlord","color":"gold"},{"text":" (random)","color":"white"}]

execute as @s[scores={countdown=72}] at @s run execute as @a[x=600,y=60,z=600,distance=..3,tag=!randclass,gamemode=adventure,scores={class=0}] at @s run tellraw @a [{"selector":"@s","color":"gold"},{"text":" spawning as: ","color":"white"},{"text":"Soldier","color":"red"}]
...
execute as @s[scores={countdown=72}] at @s run execute as @a[x=600,y=60,z=600,distance=..3,tag=!randclass,gamemode=adventure,scores={class=2}] at @s run tellraw @a [{"selector":"@s","color":"gold"},{"text":" spawning as: ","color":"white"},{"text":"Ghost","color":"aqua"}]
...
execute as @s[scores={countdown=72}] at @s run execute as @a[x=600,y=60,z=600,distance=..3,tag=!randclass,gamemode=adventure,scores={class=6}] at @s run tellraw @a [{"selector":"@s","color":"gold"},{"text":" spawning as: ","color":"white"},{"text":"Reaper","color":"gray"}]
...
execute as @s[scores={countdown=72}] at @s run execute as @a[x=600,y=60,z=600,distance=..3,tag=!randclass,gamemode=adventure,scores={class=8}] at @s run tellraw @a [{"selector":"@s","color":"gold"},{"text":" spawning as: ","color":"white"},{"text":"Gardener","color":"green"}]
...
execute as @s[scores={countdown=72}] at @s run execute as @a[x=600,y=60,z=600,distance=..3,tag=!randclass,gamemode=adventure,scores={class=10}] at @s run tellraw @a [{"selector":"@s","color":"gold"},{"text":" spawning as: ","color":"white"},{"text":"Shard","color":"dark_aqua"}]
