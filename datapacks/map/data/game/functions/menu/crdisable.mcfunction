...
data merge block 475 18 497 {Text1:"[{\"text\":\"\"}]",Text2:"[{\"text\":\"Custom Random\",\"bold\":\"true\"}]",Text3:"[{\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/scoreboard players set @e[name=menu,type=armor_stand] RoundType 1\"},\"text\":\"[disabled]\",\"color\":\"dark_red\",\"bold\":\"true\"}]",Text4:"[{\"text\":\"\"}]"}
