...
data merge block 475 18 497 {front_text:{messages:["[{\"text\":\"\"}]","[{\"text\":\"Custom Random\",\"bold\":\"true\"}]","[{\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/scoreboard players set @e[name=menu,type=armor_stand] RoundType 2\"},\"text\":\"[enabled]\",\"color\":\"dark_green\",\"bold\":\"true\"}]","[{\"text\":\"\"}]"]}}
