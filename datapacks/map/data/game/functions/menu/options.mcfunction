...
#
data merge block 475 16 497 {front_text:{messages:["[{\"text\":\"\"}]","{\"text\":\"Options\",\"bold\":true,\"clickEvent\":{\"action\":\"run_command\",\"value\":\"scoreboard players set @e[name=menu,type=armor_stand] Opt 3\"}}","{\"text\":\"[enabled]\",\"color\":\"dark_green\",\"bold\":true}","[{\"text\":\"\"}]"]}}
...
#
#execute if entity @e[name=menu,type=armor_stand,scores={DthM=0}] run data merge block 475 16 496 {"{\"text\":\"Death Messages\",\"bold\":false,\"clickEvent\":{\"action\":\"run_command\",\"value\":\"scoreboard players set @e[name=menu,type=armor_stand] DthM 2\"}}","{\"text\":\"[disabled]\",\"color\":\"dark_red\",\"bold\":true}"}
#execute if entity @e[name=menu,type=armor_stand,scores={DthM=1}] run data merge block 475 16 496 {"{\"text\":\"Death Messages\",\"bold\":false,\"clickEvent\":{\"action\":\"run_command\",\"value\":\"scoreboard players set @e[name=menu,type=armor_stand] DthM 3\"}}","{\"text\":\"[enabled]\",\"color\":\"dark_green\",\"bold\":true}"}
