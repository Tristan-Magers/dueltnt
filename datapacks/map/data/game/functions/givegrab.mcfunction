...
item replace entity @a[scores={ThrBowT=0}] hotbar.0 with minecraft:fishing_rod[unbreakable={show_in_tooltip:false},custom_name='{"italic":false,"text":"Grab : Throw to switch"}']
item replace entity @a[scores={ThrBowT=0,class=4}] hotbar.0 with minecraft:fishing_rod[unbreakable={show_in_tooltip:false},custom_name='{"italic":false,"text":"Grab : Throw to switch"}']
item replace entity @a[scores={ThrBowT=0,class=4}] hotbar.1 with minecraft:fishing_rod[unbreakable={show_in_tooltip:false},custom_name='{"italic":false,"text":"Grab : Throw to switch"}']
item replace entity @a[scores={ThrBowT=0,class=4}] hotbar.2 with minecraft:fishing_rod[unbreakable={show_in_tooltip:false},custom_name='{"italic":false,"text":"Grab : Throw to switch"}']
