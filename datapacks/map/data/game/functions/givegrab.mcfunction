...
item replace entity @a[x=620,y=20,z=620,distance=..100,scores={ThrFishT=0,class=1}] hotbar.0 with bow{Damage:40,Unbreakable:1,Enchantments:[{id:flame,lvl:1}],display:{Name:"{\"italic\":false,\"text\":\"§dBazooka Bow§r : Throw to switch\"}"}}
...
item replace entity @a[x=620,y=20,z=620,distance=..100,scores={ThrFishT=0,class=10}] hotbar.0 with bow{Damage:20,Unbreakable:1,display:{Name:"{\"italic\":false,\"text\":\"§cFrost Bow§r : Throw to switch\"}"}}
