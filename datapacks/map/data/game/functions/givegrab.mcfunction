...
execute as @a[x=620,y=20,z=620,distance=..100,scores={ThrFishT=0,class=5}] run function game:char/mads/give/bow
...
execute as @a[x=620,y=20,z=620,distance=..100,scores={ThrFishT=0,class=8}] run function game:char/gardener/give/bow