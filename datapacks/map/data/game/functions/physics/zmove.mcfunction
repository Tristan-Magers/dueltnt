...
execute as @s[scores={t4=..10}] at @s positioned ~ ~ ~ unless block ~ ~ ~.1 air unless block ~ ~ ~.1 snow run tag @s add boom
execute as @s[scores={t4=..10}] at @s positioned ~ ~ ~ unless block ~ ~ ~-.1 air unless block ~ ~ ~-.1 snow run tag @s add boom
execute as @s[scores={t4=..10}] at @s positioned ~ ~ ~ unless block ~.1 ~ ~ air unless block ~.1 ~ ~ snow run tag @s add boom
execute as @s[scores={t4=..10}] at @s positioned ~ ~ ~ unless block ~-.1 ~ ~ air unless block ~-.1 ~ ~ snow run tag @s add boom
execute as @s[scores={t4=..10}] at @s positioned ~ ~ ~ unless block ~ ~.1 ~ air unless block ~ ~.1 ~ snow run tag @s add boom
...
execute as @s[scores={t4=11..}] at @s positioned ~ ~ ~ unless block ~ ~ ~.3 air unless block ~ ~ ~.3 snow run tag @s add boom
execute as @s[scores={t4=11..}] at @s positioned ~ ~ ~ unless block ~ ~ ~-.3 air unless block ~ ~ ~-.3 snow run tag @s add boom
execute as @s[scores={t4=11..}] at @s positioned ~ ~ ~ unless block ~.3 ~ ~ air unless block ~.3 ~ ~ snow run tag @s add boom
execute as @s[scores={t4=11..}] at @s positioned ~ ~ ~ unless block ~-.3 ~ ~ air unless block ~-.3 ~ ~ snow run tag @s add boom
execute as @s[scores={t4=11..}] at @s positioned ~ ~ ~ unless block ~ ~.1 ~ air unless block ~ ~.1 ~ snow run tag @s add boom
execute as @s[scores={t4=11..}] at @s positioned ~ ~ ~ unless block ~ ~-.1 ~ air unless block ~ ~-.1 ~ snow run tag @s add boom
