...
execute as @s[tag=!chickenbowsum] run summon minecraft:arrow ~ ~ ~ {NoGravity:1,Tags:["trackshot","newtrack"]}
execute as @s[tag=chickenbowsum] run summon minecraft:arrow ~ ~ ~ {NoGravity:1,Tags:["trackshot","newtrack","trapchick"]}
...
execute as @s[tag=fast] at @s run execute store result entity @e[limit=1,tag=newtrack] Motion[0] double .01 run scoreboard players get @s DirX
execute as @s[tag=fast] at @s run execute store result entity @e[limit=1,tag=newtrack] Motion[2] double .01 run scoreboard players get @s DirZ
...
execute as @s[tag=fast] at @s run execute store result entity @e[limit=1,tag=newtrack] Motion[1] double .01 run scoreboard players get @s y
