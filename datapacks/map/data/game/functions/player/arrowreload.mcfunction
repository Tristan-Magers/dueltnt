...
item replace entity @s[scores={class=2,bow=60..}] hotbar.5 with minecraft:tipped_arrow{display:{Name:"{\"italic\":false,\"text\":\"Magic arrow\"}"},Potion:"minecraft:swiftness",HideFlags:32} 3
...
item replace entity @s[scores={class=10,bow=46..}] hotbar.6 with arrow 3
execute as @s[scores={class=10,bow=44..}] at @s run playsound minecraft:entity.item.pickup master @p ~ ~ ~ .4 2
scoreboard players set @s[scores={class=10,bow=46..}] bow -2