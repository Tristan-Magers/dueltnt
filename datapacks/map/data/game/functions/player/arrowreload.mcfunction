...
item replace entity @s[scores={class=6,bow=22..}] hotbar.6 with arrow 1
execute as @s[scores={class=6,bow=22..}] at @s run playsound minecraft:entity.item.pickup master @p ~ ~ ~ .4 2
scoreboard players set @s[scores={class=6,bow=22..}] bow 0
