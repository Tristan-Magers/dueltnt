...
execute if score #goobTick particle matches ..-1 run particle minecraft:dust{color:[1.0, 1.0, 1.0], scale:0.5} ~ ~ ~ 0.1 0 0.1 0 2 force @a
execute if score #goobTick particle matches ..-1 run particle electric_spark ^ ^ ^0.8 0 0 0 0 1 force @a
execute if score #goobTick particle matches ..-1 run particle minecraft:dust{color:[1.0, 0.7, 0.0], scale:1.0} ^ ^ ^0.8 0.065 0.065 0.065 0 3 force @a
