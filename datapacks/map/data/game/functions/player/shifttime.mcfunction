...
scoreboard players set @s[gamemode=adventure,scores={timer=73..,class=2}] timer 0
...
scoreboard players set @s[gamemode=adventure,scores={timer=160..,class=4}] timer 0
...
scoreboard players set @s[gamemode=adventure,scores={timer=95..,class=10}] timer 0