...
scoreboard players set @s[gamemode=adventure,scores={timer=50..,class=1}] timer 0
...
execute unless entity @e[scores={mode=1}] run scoreboard players set @s[gamemode=adventure,scores={timer=170..,class=7}] timer 0
