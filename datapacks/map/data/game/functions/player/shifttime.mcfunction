...
scoreboard players set @s[gamemode=adventure,scores={timer=80..,class=2}] timer 0
...
scoreboard players set @s[gamemode=adventure,scores={timer=90..,class=10}] timer 0