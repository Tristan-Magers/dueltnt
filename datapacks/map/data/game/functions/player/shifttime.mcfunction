...
scoreboard players set @s[gamemode=adventure,scores={timer=75..,class=2}] timer 0
...
scoreboard players set @s[gamemode=adventure,scores={timer=88..,class=10}] timer 0