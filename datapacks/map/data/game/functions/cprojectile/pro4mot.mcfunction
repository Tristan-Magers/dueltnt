...
execute as @s[nbt={OnGround:0b}] at @s positioned ~ ~0.2 ~ run summon minecraft:fireball ^ ^ ^1.2 {Tags:["trackshot2","newtrack"],Motion:[0.0d,0.0d,0.0d],Invulnerable:0b,Air:300s,OnGround:0b,Dimension:0,ExplosionPower:4,PortalCooldown:0,Rotation:[0.0f,0.0f],Fire:-1s,power:[0.0d,-0.001d,-0.0d],direction:[0.0d,-0.001d,0.0d]}
