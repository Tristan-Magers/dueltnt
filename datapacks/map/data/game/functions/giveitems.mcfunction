...
#item replace entity @a[scores={class=1},x=620,y=20,z=620,distance=..100] hotbar.1 with splash_potion{CustomPotionColor:0,CustomPotionEffects:[{Id:2,Amplifier:1,Duration:60},{Id:15,Amplifier:1,Duration:60},{Id:24,Amplifier:1,Duration:60}],display:{Name:"{\"italic\":false,\"text\":\"§5Primed for Death §r: Right-click\"}"}}
