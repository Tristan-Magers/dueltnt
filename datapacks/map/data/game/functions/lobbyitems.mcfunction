...
clear @a[nbt=!{Inventory:[{id:"minecraft:red_concrete_powder",Slot:0b}]},x=500,y=20,z=450,distance=..140,scores={ingame=..0},gamemode=adventure] minecraft:red_concrete_powder
item replace entity @a[nbt=!{Inventory:[{id:"minecraft:red_concrete_powder",Slot:0b}]},x=500,y=20,z=450,distance=..140,scores={ingame=..0},gamemode=adventure] hotbar.0 with minecraft:red_concrete_powder{display:{Name:"{\"italic\":false,\"text\":\"Not in game! (Throw to join)\"}"}}
