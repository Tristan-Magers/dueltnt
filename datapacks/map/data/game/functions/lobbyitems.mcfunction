...
item replace entity @a[nbt=!{Inventory:[{id:"minecraft:red_concrete_powder",Slot:0b}]},x=500,y=20,z=450,distance=..140,scores={ingame=..0,lobby=10..},gamemode=adventure,tag=!delay_items] hotbar.0 with minecraft:red_concrete_powder{display:{Name:"{\"italic\":false,\"text\":\"Not in game! (Throw to join)\"}"}}
...
item replace entity @a[nbt=!{Inventory:[{id:"minecraft:green_concrete_powder",Slot:0b}]},x=500,y=20,z=450,distance=..140,scores={ingame=1..,lobby=10..},gamemode=adventure,tag=!delay_items] hotbar.0 with minecraft:green_concrete_powder{display:{Name:"{\"italic\":false,\"text\":\"Joined game (Throw to leave)\"}"}}
