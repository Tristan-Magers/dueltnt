...
execute if entity @e[tag=Map,scores={whootext=0}] run tellraw @a {"text":"WHOOO! Duel TNT is now 3+ years old. Published 6/30/2017, its been a fun ride, and we are here to celebrate with SEASON 7.1! I worked really hard to add lots of cool new features. \n\nHere is to many more maps and years to come. :3 \n\n-ChainsawNinja"}
