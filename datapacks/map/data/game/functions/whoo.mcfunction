...
execute if entity @e[tag=Map,scores={whootext=0}] run tellraw @a {"text":"WHOOO! Duel TNT is now 7 years old. Published 6/30/2017, it's been a fun ride, and we are here to celebrate with SEASON 9!\n\nIt has been quite the journey. :3 \n\n-ChainsawNinja"}
