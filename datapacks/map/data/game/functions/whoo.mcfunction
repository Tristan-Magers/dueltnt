...
execute if entity @e[tag=Map,scores={whootext=0}] run tellraw @a {"text":"WHOOO! Duel TNT is now 4 years old. Published 6/30/2017, its been a fun ride, and we are here to celebrate with SEASON 8!\n\nHere is to much more to come. :3 \n\n-ChainsawNinja"}
