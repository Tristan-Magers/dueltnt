...
execute as @a[scores={phantom=240..}] at @s run execute as @e[tag=new] at @s run function game:phantomsummonitem
...
execute as @a[scores={phantomboost=0}] at @s run function game:phantomboostreset

effect give @e[tag=powerupitem] glowing 10 0
execute as @e[tag=powerupitem] at @s run function game:powerupitem
