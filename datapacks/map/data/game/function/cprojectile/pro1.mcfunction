...
summon armor_stand ~ ~ ~ {Pose:{LeftArm:[90.0f,-70.0f,0.0f]},DisabledSlots:4144959,Invisible:1,NoGravity:1,NoAI:1,Invulnerable:1,Size:0,tags:["newS"],CustomName:{"text":"pro1"},equipment:{mainhand:{id:"minecraft:iron_hoe",count:1}}}
