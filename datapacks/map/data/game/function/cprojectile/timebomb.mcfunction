summon minecraft:armor_stand ~ ~ ~ {Small:1,Marker:0,Invulnerable:1,Tags:["timebombpro","newbomb"],Invisible:1,equipment:{head:{id:"minecraft:sculk_sensor",count:1}},DisabledSlots:4144959}
