...
scoreboard players set @s master_bomb_cooldown 22

summon minecraft:armor_stand ~ ~ ~ {Small:1,Marker:0,Invulnerable:1,Tags:["mastertnt","newbomb"],Invisible:1,equipment:{head:{id:"minecraft:air",count:1}},DisabledSlots:4144959}
