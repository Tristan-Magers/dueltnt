...
execute as @s[x=580,dx=80,y=-1,dy=100,z=580,dz=80,distance=..100,scores={grounduse=1}] at @s run tellraw @a[gamemode=spectator] [{"selector":"@s"},{"text":" Used ","color":"white"},{"text":"Ground Spell","color":"yellow","bold":true},{"text":" (0 Remaining) ","color":"white"}]
