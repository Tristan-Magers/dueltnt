execute as @s[name=map1,scores={CustomRandom=2}] at @s run setblock 474 18 501 oak_wall_sign[facing=east]{front_text:{messages:["[{\"text\":\"\"}]","[{\"text\":\"Core\",\"bold\":true}]","[{\"clickEvent\":{\"action\":\"run_command\",\"value\":\"scoreboard players set @e[name=map1] CustomRandom 3\"},\"text\":\"[disabled]\",\"color\":\"dark_red\",\"bold\":true}]","[{\"text\":\"competitive\",\"color\":\"#8F6C18\"}]"]}} destroy
execute as @s[name=map1,scores={CustomRandom=2}] at @s run scoreboard players set @s CustomRandom 0

execute as @s[name=map1,scores={CustomRandom=3}] at @s run setblock 474 18 501 oak_wall_sign[facing=east]{front_text:{messages:["[{\"text\":\"\"}]","[{\"text\":\"Core\",\"bold\":true}]","[{\"clickEvent\":{\"action\":\"run_command\",\"value\":\"scoreboard players set @e[name=map1] CustomRandom 2\"},\"text\":\"[enabled]\",\"color\":\"dark_green\",\"bold\":true}]","[{\"text\":\"competitive\",\"color\":\"#8F6C18\"}]"]}} destroy
execute as @s[name=map1,scores={CustomRandom=3}] at @s run scoreboard players set @s CustomRandom 1

execute as @s[name=map2,scores={CustomRandom=2}] at @s run setblock 474 18 500 oak_wall_sign[facing=east]{front_text:{messages:["[{\"text\":\"\"}]","[{\"text\":\"N. Strong\",\"bold\":true}]","[{\"clickEvent\":{\"action\":\"run_command\",\"value\":\"scoreboard players set @e[name=map2] CustomRandom 3\"},\"text\":\"[enabled]\",\"color\":\"dark_green\",\"bold\":true}]","[{\"text\":\"competitive\",\"color\":\"#8F6C18\"}]"]}} destroy
execute as @s[name=map2,scores={CustomRandom=2}] at @s run scoreboard players set @s CustomRandom 1

execute as @s[name=map2,scores={CustomRandom=3}] at @s run setblock 474 18 500 oak_wall_sign[facing=east]{front_text:{messages:["[{\"text\":\"\"}]","[{\"text\":\"N. Strong\",\"bold\":true}]","[{\"clickEvent\":{\"action\":\"run_command\",\"value\":\"scoreboard players set @e[name=map2] CustomRandom 2\"},\"text\":\"[disabled]\",\"color\":\"dark_red\",\"bold\":true}]","[{\"text\":\"competitive\",\"color\":\"#8F6C18\"}]"]}} destroy
...
execute as @s[name=map5,scores={CustomRandom=2}] at @s run setblock 474 17 500 oak_wall_sign[facing=east]{front_text:{messages:["[{\"text\":\"\"}]","[{\"text\":\"The End\",\"bold\":true}]","[{\"clickEvent\":{\"action\":\"run_command\",\"value\":\"scoreboard players set @e[name=map5] CustomRandom 3\"},\"text\":\"[enabled]\",\"color\":\"dark_green\",\"bold\":true}]","[{\"text\":\"competitive\",\"color\":\"#8F6C18\"}]"]}} destroy
execute as @s[name=map5,scores={CustomRandom=2}] at @s run scoreboard players set @s CustomRandom 1

execute as @s[name=map5,scores={CustomRandom=3}] at @s run setblock 474 17 500 oak_wall_sign[facing=east]{front_text:{messages:["[{\"text\":\"\"}]","[{\"text\":\"The End\",\"bold\":true}]","[{\"clickEvent\":{\"action\":\"run_command\",\"value\":\"scoreboard players set @e[name=map5] CustomRandom 2\"},\"text\":\"[disabled]\",\"color\":\"dark_red\",\"bold\":true}]","[{\"text\":\"competitive\",\"color\":\"#8F6C18\"}]"]}} destroy
execute as @s[name=map5,scores={CustomRandom=3}] at @s run scoreboard players set @s CustomRandom 0

execute as @s[name=map6,scores={CustomRandom=2}] at @s run setblock 474 17 499 oak_wall_sign[facing=east]{front_text:{messages:["[{\"text\":\"\"}]","[{\"text\":\"Dead Feast\",\"bold\":true}]","[{\"clickEvent\":{\"action\":\"run_command\",\"value\":\"scoreboard players set @e[name=map6] CustomRandom 3\"},\"text\":\"[enabled]\",\"color\":\"dark_green\",\"bold\":true}]","[{\"text\":\"competitive\",\"color\":\"#8F6C18\"}]"]}} destroy
execute as @s[name=map6,scores={CustomRandom=2}] at @s run scoreboard players set @s CustomRandom 1

execute as @s[name=map6,scores={CustomRandom=3}] at @s run setblock 474 17 499 oak_wall_sign[facing=east]{front_text:{messages:["[{\"text\":\"\"}]","[{\"text\":\"Dead Feast\",\"bold\":true}]","[{\"clickEvent\":{\"action\":\"run_command\",\"value\":\"scoreboard players set @e[name=map6] CustomRandom 2\"},\"text\":\"[disabled]\",\"color\":\"dark_red\",\"bold\":true}]","[{\"text\":\"competitive\",\"color\":\"#8F6C18\"}]"]}} destroy
execute as @s[name=map6,scores={CustomRandom=3}] at @s run scoreboard players set @s CustomRandom 0

execute as @s[name=map7,scores={CustomRandom=2}] at @s run setblock 474 16 501 oak_wall_sign[facing=east]{front_text:{messages:["[{\"text\":\"\"}]","[{\"text\":\"Arena\",\"bold\":true}]","[{\"clickEvent\":{\"action\":\"run_command\",\"value\":\"scoreboard players set @e[name=map7] CustomRandom 3\"},\"text\":\"[enabled]\",\"color\":\"dark_green\",\"bold\":true}]","[{\"text\":\"competitive\",\"color\":\"#8F6C18\"}]"]}} destroy
execute as @s[name=map7,scores={CustomRandom=2}] at @s run scoreboard players set @s CustomRandom 1

execute as @s[name=map7,scores={CustomRandom=3}] at @s run setblock 474 16 501 oak_wall_sign[facing=east]{front_text:{messages:["[{\"text\":\"\"}]","[{\"text\":\"Arena\",\"bold\":true}]","[{\"clickEvent\":{\"action\":\"run_command\",\"value\":\"scoreboard players set @e[name=map7] CustomRandom 2\"},\"text\":\"[disabled]\",\"color\":\"dark_red\",\"bold\":true}]","[{\"text\":\"competitive\",\"color\":\"#8F6C18\"}]"]}} destroy
...
execute as @s[name=map12,scores={CustomRandom=2}] at @s run setblock 474 17 501 oak_wall_sign[facing=east]{front_text:{messages:["[{\"text\":\"\"}]","[{\"text\":\"Terminal\",\"bold\":true}]","[{\"clickEvent\":{\"action\":\"run_command\",\"value\":\"scoreboard players set @e[name=map12] CustomRandom 3\"},\"text\":\"[enabled]\",\"color\":\"dark_green\",\"bold\":true}]","[{\"text\":\"competitive\",\"color\":\"#8F6C18\"}]"]}} destroy
