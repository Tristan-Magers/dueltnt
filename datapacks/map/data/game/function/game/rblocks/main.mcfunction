...
execute as @s[scores={t1=38}] at @s run playsound minecraft:entity.breeze.whirl master @a ~ ~ ~ 0.6 0.9
execute as @s[scores={t1=8}] at @s run playsound minecraft:entity.breeze.land master @a ~ ~ ~ 0.6 0
execute as @s[scores={t1=5}] at @s run playsound minecraft:entity.breeze.land master @a ~ ~ ~ 0.6 1
