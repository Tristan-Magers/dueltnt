...
execute as @s[x=597.1,z=597.1,y=0,dx=40.8,dz=40.8,dy=108,distance=..1000,scores={blast=7..}] store result score @s t5 run fill ~.95 ~ ~ ~-.95 ~ ~ air replace #game:bolt_place
scoreboard players operation @s t6 += @s t5
execute as @s[x=597.1,z=597.1,y=0,dx=40.8,dz=40.8,dy=108,distance=..1000,scores={blast=7..}] store result score @s t5 run fill ~ ~ ~.95 ~ ~ ~-.95 air replace #game:bolt_place
scoreboard players operation @s t6 += @s t5
execute as @s[x=597.1,z=597.1,y=0,dx=40.8,dz=40.8,dy=108,distance=..1000,scores={blast=7..}] store result score @s t5 run fill ~ ~.95 ~ ~ ~-.95 ~ air replace #game:bolt_place
scoreboard players operation @s t6 += @s t5
execute as @s[x=597.1,z=597.1,y=0,dx=40.8,dz=40.8,dy=108,distance=..1000,scores={blast=7..}] store result score @s t5 run fill ~.60 ~.60 ~.60 ~-.60 ~-.60 ~-.60 air replace #game:bolt_place
scoreboard players operation @s t6 += @s t5
