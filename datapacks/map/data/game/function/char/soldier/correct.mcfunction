...
item replace entity @s[nbt=!{Inventory:[{id:"minecraft:ender_pearl",Slot:2b}]},scores={endercount=4}] hotbar.2 with minecraft:ender_pearl[use_cooldown={seconds:5,cooldown_group:"soldierp"},custom_name={"italic":false,"text":"§aTeleport §r: Right-click"},lore=[{"italic":false,"color":"white","text":"1s Levitation 9 when teleported"},{"italic":false,"color":"white","text":"Reloads all shift charges when teleported"},{"italic":false,"color":"white","text":"Does not reload"}]] 1
item replace entity @s[nbt=!{Inventory:[{id:"minecraft:ender_pearl",Slot:2b}]},scores={endercount=3}] hotbar.2 with minecraft:ender_pearl[use_cooldown={seconds:5,cooldown_group:"soldierp"},custom_name={"italic":false,"text":"§aTeleport §r: Right-click"},lore=[{"italic":false,"color":"white","text":"1s Levitation 9 when teleported"},{"italic":false,"color":"white","text":"Reloads all shift charges when teleported"},{"italic":false,"color":"white","text":"Does not reload"}]] 2
item replace entity @s[nbt=!{Inventory:[{id:"minecraft:ender_pearl",Slot:2b}]},scores={endercount=2}] hotbar.2 with minecraft:ender_pearl[use_cooldown={seconds:5,cooldown_group:"soldierp"},custom_name={"italic":false,"text":"§aTeleport §r: Right-click"},lore=[{"italic":false,"color":"white","text":"1s Levitation 9 when teleported"},{"italic":false,"color":"white","text":"Reloads all shift charges when teleported"},{"italic":false,"color":"white","text":"Does not reload"}]] 3
item replace entity @s[nbt=!{Inventory:[{id:"minecraft:ender_pearl",Slot:2b}]},scores={endercount=1}] hotbar.2 with minecraft:ender_pearl[use_cooldown={seconds:5,cooldown_group:"soldierp"},custom_name={"italic":false,"text":"§aTeleport §r: Right-click"},lore=[{"italic":false,"color":"white","text":"1s Levitation 9 when teleported"},{"italic":false,"color":"white","text":"Reloads all shift charges when teleported"},{"italic":false,"color":"white","text":"Does not reload"}]] 4
item replace entity @s[nbt=!{Inventory:[{id:"minecraft:ender_pearl",Slot:2b}]},scores={endercount=0}] hotbar.2 with minecraft:ender_pearl[use_cooldown={seconds:5,cooldown_group:"soldierp"},custom_name={"italic":false,"text":"§aTeleport §r: Right-click"},lore=[{"italic":false,"color":"white","text":"1s Levitation 9 when teleported"},{"italic":false,"color":"white","text":"Reloads all shift charges when teleported"},{"italic":false,"color":"white","text":"Does not reload"}]] 5
