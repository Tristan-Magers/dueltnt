...
execute as @a[scores={time_pos=19}] at @s run summon husk ~ ~100 ~ {Tags:["timeposmark"],NoAI:1,Invulnerable:1,Silent:1,NoGravity:1,Invisible:1,equipment:{head:{id:"minecraft:beetroot",count:1}}}
