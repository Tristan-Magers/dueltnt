...
item replace entity @s[scores={masterb=..5,master_bomb_cooldown=..0}] hotbar.1 with minecraft:barrier[custom_name={"italic":false,"text":"§9Not enough material"},lore=[{"italic":false,"color":"white","text":"2 TNT"},{"italic":false,"color":"white","text":"Reload: 1.2s"},{"italic":false,"color":"white","text":"Fuse: 0.75s"}]] 1
item replace entity @s[scores={master_bomb_cooldown=1..}] hotbar.1 with minecraft:beetroot[custom_name={"italic":false,"text":"§9On Cooldown"},lore=[{"italic":false,"color":"white","text":"2 TNT"},{"italic":false,"color":"white","text":"Reload: 1.2s"},{"italic":false,"color":"white","text":"Fuse: 0.75s"}]] 1
