...
# matter bomb
item replace entity @s[scores={masterb=6..,master_bomb_cooldown=..0}] hotbar.1 with minecraft:salmon[custom_name={"italic":false,"text":"§4Matter Bomb §r: Right-click (6 Material)"},lore=[{"italic":false,"color":"white","text":"2 TNT"},{"italic":false,"color":"white","text":"Reload: 1.1s"},{"italic":false,"color":"white","text":"Fuse: 0.75s"}]]
clear @s[scores={masterb=..5}] salmon
item replace entity @s[scores={masterb=..5,master_bomb_cooldown=..0}] hotbar.1 with minecraft:barrier[custom_name={"italic":false,"text":"§9Not enough material"},lore=[{"italic":false,"color":"white","text":"2 TNT"},{"italic":false,"color":"white","text":"Reload: 1.1s"},{"italic":false,"color":"white","text":"Fuse: 0.75s"}]] 1
item replace entity @s[scores={master_bomb_cooldown=1..}] hotbar.1 with minecraft:beetroot[custom_name={"italic":false,"text":"§9On Cooldown"},lore=[{"italic":false,"color":"white","text":"2 TNT"},{"italic":false,"color":"white","text":"Reload: 1.1s"},{"italic":false,"color":"white","text":"Fuse: 0.75s"}]] 1
...
# matter storm
item replace entity @s[scores={masterb=10..}] hotbar.2 with minecraft:cooked_salmon[custom_name={"italic":false,"color":"#3276DB","text":"Matter Storm §f: Right-click (10 Material)"},lore=[{"italic":false,"color":"white","text":"3x1 TNT"},{"italic":false,"color":"white","text":"Reload: 4.2s"},{"italic":false,"color":"white","text":"Delay: 0s, 0.1s, 0.2s"},{"italic":false,"color":"white","text":"Velocity: 4.4 bps"},{"italic":false,"color":"white","text":"Fuse: 1.5"},{"italic":false,"color":"white","text":"Explode instantly if all land"}]]
clear @s[scores={masterb=..9}] cooked_salmon
item replace entity @s[scores={masterb=..9}] hotbar.2 with minecraft:barrier[custom_name={"italic":false,"text":"§9Not enough material"},lore=[{"italic":false,"color":"white","text":"3x1 TNT"},{"italic":false,"color":"white","text":"Reload: 4.2s"},{"italic":false,"color":"white","text":"Delay: 0s, 0.1s, 0.2s"},{"italic":false,"color":"white","text":"Velocity: 4.4 bps"},{"italic":false,"color":"white","text":"Fuse: 1.5"},{"italic":false,"color":"white","text":"Explode instantly if all land"}]] 1
item replace entity @s[scores={storm_cooldown=1..}] hotbar.2 with minecraft:beetroot[custom_name={"italic":false,"text":"§9On Cooldown"},lore=[{"italic":false,"color":"white","text":"3x1 TNT"},{"italic":false,"color":"white","text":"Reload: 4.2s"},{"italic":false,"color":"white","text":"Delay: 0s, 0.1s, 0.2s"},{"italic":false,"color":"white","text":"Velocity: 4.4 bps"},{"italic":false,"color":"white","text":"Fuse: 1.5"},{"italic":false,"color":"white","text":"Explode instantly if all land"}]] 1
