...
item replace entity @s[scores={class=2,bow=60..}] hotbar.5 with minecraft:tipped_arrow[custom_name={"italic":false,"text":"Crit arrow"},potion_contents={custom_color:6221823},tooltip_display={hidden_components:["attribute_modifiers","can_break","custom_model_data","unbreakable","tooltip_display","weapon","max_damage","can_place_on","trim","dyed_color","damage","enchantments","food","tool","tooltip_display","potion_contents","item_model"]}] 3
...
item replace entity @s[scores={class=4,bow=22}] hotbar.6 with tipped_arrow[custom_name={"italic":false,"text":"Magic Arrow"},potion_contents={custom_color:6221823},tooltip_display={hidden_components:["attribute_modifiers","can_break","custom_model_data","unbreakable","tooltip_display","weapon","max_damage","can_place_on","trim","dyed_color","damage","enchantments","food","tool","tooltip_display","potion_contents","item_model"]}] 2
...
item replace entity @s[scores={class=7,bow=35..}] hotbar.5 with arrow 1
execute as @s[scores={class=7,bow=35..}] at @s run playsound minecraft:entity.item.pickup master @p ~ ~ ~ .4 2
scoreboard players set @s[scores={class=7,bow=35..}] bow 0
