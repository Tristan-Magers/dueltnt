...
scoreboard players set @s[gamemode=adventure,scores={timer=43..,class=1}] timer 0
scoreboard players set @s[gamemode=adventure,scores={timer=76..,class=2}] timer 0
scoreboard players set @s[gamemode=adventure,scores={timer=33..,class=3}] timer 0
...
execute unless entity @e[scores={mode=1}] run scoreboard players set @s[gamemode=adventure,scores={timer=51..,class=7}] timer 0
...
scoreboard players set @s[gamemode=adventure,scores={timer=33..,class=10}] timer 0