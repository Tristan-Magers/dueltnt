...
# Calculations
execute store result score #trVal .num run random value 1..10
...
execute as @s[scores={particle=904}] at @s rotated ~ 0 run function game:tournament_rewards/os1/singles/main