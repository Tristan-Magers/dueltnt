...
execute as @s[scores={teamed=0}] if score #woa1Val .num matches ..5 run particle minecraft:firework ~ ~ ~ 0.075 0.075 0.075 0.03 1 force @a
execute as @s[tag=red,scores={teamed=1}] if score #woa1Val .num matches ..5 run particle minecraft:flame ~ ~ ~ 0.075 0.075 0.075 0.02 1 force @a
execute as @s[tag=blue,scores={teamed=1}] run particle minecraft:enchanted_hit ~ ~ ~ 0.075 0.075 0.075 0.05 1 force @a
execute as @s[tag=green,scores={teamed=1}] if score #woa1Val .num matches ..7 run particle minecraft:scrape ~ ~ ~ 0.075 0.075 0.075 0 1 force @a