...
execute if score #trVal .num matches 1..8 positioned ~ ~0.3 ~ run particle minecraft:trial_spawner_detection ^ ^ ^-0.3 0.1 0 0.1 0 1 force @a
execute if score #trVal .num matches 1..6 positioned ~ ~0.1 ~ run particle minecraft:smoke ^ ^ ^-0.3 0.1 0 0.1 0 1 force @a
execute if score #trVal .num matches 1..2 run particle flame ~ ~0.025 ~ 0.1 0.1 0.1 0 1 force @a
